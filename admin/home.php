      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="#chart" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
...
try {
    ...
    foreach ($product_votes as $vote) {
        ...
        $chartData[$city][$productName] = $voteCount;
    }
...
echo "<h4>Products voting</h4>";
// Include Chart.js library
echo '<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>';

// Render the chart
echo '<canvas id="productVotesChart"></canvas>';

// JavaScript to populate the chart
echo '<script>';
echo 'var ctx = document.getElementById("productVotesChart").getContext("2d");';
echo 'var chartData = ' . json_encode($chartData) . ';';
echo 'var chartLabels = ' . json_encode(array_keys($chartData)) . ';';
echo 'var chartDatasets = [];';
echo 'chartLabels.forEach(function(city) {';
echo '    var data = chartData[city];';
echo '    var dataset = {';
echo '        label: city,';
echo '        data: Object.values(data),';
echo '        backgroundColor: getRandomColor(),'; // Call function to get random color
echo '        borderColor: "rgba(54, 162, 235, 1)",';
echo '        borderWidth: 1';
echo '    };';
echo '    chartDatasets.push(dataset);';
echo '});';
echo 'var chart = new Chart(ctx, {';
echo '    type: "bar",';
echo '    data: {';
echo '        labels: Object.keys(chartData[chartLabels[0]]),';
echo '        datasets: chartDatasets';
echo '    },';
echo '    options: {';
echo '        scales: {';
echo '            yAxes: [{';
...
echo '        color += letters[Math.floor(Math.random() * 16)];';
echo '    }';
echo '    return color;';
echo '}';
echo '</script>';
