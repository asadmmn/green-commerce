      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM products WHERE user_id = ?");
...
try {
    ...
    foreach ($product_votes as $vote) {
        ...
        $chartData[$productName][$city] = $voteCount;
    }
...
echo 'chartLabels.forEach(function(product) {';
echo '    var data = chartData[product];';
echo '    var dataset = {';
echo '        label: product,';
